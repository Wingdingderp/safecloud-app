...
const features = [
  ...
  },
  {
    name: "Community",
    description:
      "Our community is friendly and welcoming, and we offer an active Discord community, we focus on building, working together, and having fun as a community, without relying on pay-to-win practices.",
    icon: UserGroupIcon,
  },
  {
    name: "Vane",
