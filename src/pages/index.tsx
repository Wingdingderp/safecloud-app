...
const Home: NextPage = () => {
  return (
    <>
      <NextSeo
        title="SafeCloud SMP"
        description="SafeCloud SMP is a semi-vanilla Minecraft server hosted in US-East that offers an immersive and unique experience to its players."
      />
          ...
          <div className="hero-content flex-col lg:flex-row">
            <div>
              ...
              <p className="my-5 py-6 text-lg">
                ...
                in US-East that offers an immersive and unique experience to its
                players.
              </p>
