...
> = ({ mcmmoData, notFound, profile }) => {
  ...
  return (
    <>
      <Head>
        <title>{username} - SMPstats</title>
        <meta content={`${username}, SMP Stats`} property="og:title" />
        <meta
          content={`SMP Stats for ${username}. Their Power Level is ${
        ...
        />
        <meta content="https://stats.safecloud.quest/" property="og:url" />
        <meta
